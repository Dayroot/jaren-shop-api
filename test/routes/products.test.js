...
describe('Products Endpoints', () => {
		...
		it('Responds with all products data', () =>
			agent
				...
				.then( res => {
					...
					res.body.body.forEach( (product, i) => {
						expect(typeof product).toBe('object');
	...
	describe('PATCH /:id', () => {
		...
		it('Update the product that correspond the id indicated and responds with the product data', () =>
			agent
				.patch("/api/v1/products/1")
				.send({
					description: "The description was updated",
		...
		it('If the variant id does not correspond to any variant, responds with Error 404', () =>
			agent
				.patch("/api/v1/products/1")
				.send({
					description: "The description was updated",
		...
		it('If the data contains the images property, responds with Error 400', () =>
			agent
				.patch("/api/v1/products/1")
				.send({
					description: "The description was updated",
