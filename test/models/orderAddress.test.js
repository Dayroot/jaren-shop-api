...
//Models
const OrderAddressModel = require(path.resolve(process.cwd(), 'src', 'db', 'models', 'orderAddress.model.js'));

describe('Order Address model', () => {

	beforeEach(async () => {
		await OrderAddressModel.sync({force: true});
	});
